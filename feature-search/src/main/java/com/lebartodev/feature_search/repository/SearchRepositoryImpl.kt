...
class SearchRepositoryImpl @Inject constructor(
    ...
    private val searchStateFlow = MutableStateFlow<Response<List<MovieEntity>>>(Response.Loading())

    override fun result(): Flow<Response<List<MovieEntity>>> = searchStateFlow
